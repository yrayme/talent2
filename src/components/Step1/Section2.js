    ...
    return (
        <Grid container pt={6} spacing={2}>
            <Grid item xs={12} md={5}>
                <Box px={{xs: 2, md:0}}>
                    <Typography variant='h6' fontWeight={700}>Social presence</Typography>
                </Box>
                            ...
                            <Grid item xs={12} md={12} mt={1}>
                                ...
                                >                      
                                    <Box
                                        sx={stylesIcon}
                                    >
                                        <LinkedInIcon sx={{color: theme.grayLight}}/> 
                            ...
                            <Grid item xs={12} md={12} mt={1}>
                                ...
                                >            
                                    <Box
                                        sx={stylesIcon}
                                    >
                                        <FacebookIcon sx={{color: theme.grayLight}}/> 
                                        <Divider orientation="vertical" flexItem />
                                    </Box>                                 
                                </CustomTextField>
                            </Grid>
                            ...
                            <Grid item xs={12} md={12} mt={1}>
                                ...
                                >            
                                    <Box
                                        sx={stylesIcon}
                                    >
                                        <TwitterIcon sx={{color: theme.grayLight}}/> 
                                        <Divider orientation="vertical" flexItem />
                                    </Box>                               
                                </CustomTextField>
                            </Grid>
